...
public class Rentalmobil {
    ...
    public static void main(String[] args) throws IOException {
        ...
        BufferedReader br = new BufferedReader(isr);
         ...
         ArrayList <Keterangan> ket = new ArrayList<>();
        ...
        while (true){
            ...
            switch (menu) {
                case 1:
                    ...
                    switch(pilih){
                        case 1 : 
                            ...
                            System.out.print("Masukkan jumlah mobil yang dirental : ");
                            int jumlahpinjam = Integer.parseInt(br.readLine());
                            ...
                            datasewamobil baru = new datasewamobil( namaPenyewa,  alamat,  nohp,jumlahpinjam, namamobil, idsewa,  hargaperhari);
                ...
                case 2:
                    ...
                    System.out.println("1. Data penyewa Mobil ");
                    System.out.println("2. Data  Mobil kembali");
                    System.out.println("3. keterangan ");
                    System.out.println("======================");
                    ...
                    switch (choose) {
                        case 1:
                            ...
                            for (int i = 0; i < dtsewamobil.size(); i++){
                                ...
                                System.out.println("jumlah pinjam : " + dtsewamobil.get(i).getjumlahpinjam());
                    ...
                    if(menuEdit == 1){
                        ...
                        for(datasewamobil sewa : dtsewamobil){
                            if(sewa.getnamaPenyewa().equals(findsewa)){
                                ...
                                System.out.println("hp           : "); sewa.setjumlahpinjam(Integer.parseInt(br.readLine()));
